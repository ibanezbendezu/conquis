...
export default function HonorCard({honor, onClick, isDark, viewMode}: HonorCardProps) {
        ...
        return (
            ...
            >
                <div className="flex items-center gap-4 min-w-0">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                           <span
                               className={`text-[10px] font-bold px-1.5 py-0.5 rounded-sm ${isDark ? "bg-neutral-800 text-neutral-400" : "bg-neutral-100 text-neutral-500"}`}>
                ...
                <div className="flex items-center gap-4">
                    <div
                        className={`hidden sm:flex items-center gap-1 text-xs font-medium px-2 py-1 rounded-md ${isDark ? "bg-neutral-800 text-neutral-400" : "bg-neutral-100 text-neutral-500"}`}>
    ...
    return (
        ...
        >
            ...
            <span
                className={`text-[10px] font-bold px-1.5 py-0.5 rounded-sm truncate ${isDark ? "bg-neutral-800 text-neutral-400" : "bg-neutral-100 text-neutral-500"}`}>
              {honor.categoryCode}-{String(honor.honorId).padStart(3, '0')}
            </span>
                {/* AQUÍ ESTÁ LA SOLUCIÓN: Agregamos whitespace-nowrap y flex-shrink-0 */}
                <div
                    className={`flex items-center gap-1 text-[10px] font-medium px-1.5 py-0.5 rounded-md whitespace-nowrap flex-shrink-0 ${isDark ? "bg-neutral-800 text-neutral-400" : "bg-neutral-100 text-neutral-500"}`}>
