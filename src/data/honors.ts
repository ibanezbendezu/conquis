...
export const honorData: Honor[] = [
    {
        ...
        requirements: [
            ...
            { id: 2, description: "Hacer una lista de los distintos tipos de sentimientos y emociones humanas. Hacer una lista y escribir un ejemplo de cuándo los ha experimentado en su vida." },
            {
                id: 3,
            ...
            { id: 4, description: "Leer Gálatas 5:22-23 y escribir una lista de los atributos del Fruto del Espíritu. Explicar con sus propias palabras por qué es importante cultivar el Fruto del Espíritu en nuestras vidas." },
            ...
            { id: 9, description: "Leer Mateo 22:36-40 y hablar con su instructor o consejero sobre la importancia del amor propio para que más tarde pueda amar a otros." },
            { id: 10, description: "Hacer una lista de los desafíos en los que debe trabajar para gestionar mejor sus emociones." },
            { id: 11, description: "Grabar un video y compartirlo en sus redes sociales hablando sobre cómo manejar las emociones, basándose en el capítulo 84 del libro «Mente, carácter y personalidad (Vol. 2)»." }
        ]
    },
...

    {
        ...
        requirements: [
            ...
            { id: 3, description: "Comprender el significado de la frase: «Dime con quién andas y te diré quién eres» y relacionarla con el texto de 1 Corintios 15:33." },
            ...
            { id: 9, description: "Conocer los mecanismos legales disponibles en su país, estado o municipio para la protección y ayuda de las víctimas de relaciones abusivas y las sanciones correspondientes." },
            {
                id: 10,
            ...
            { id: 11, description: "Compartir las principales lecciones aprendidas en esta especialidad con cinco familiares y amigos." },
            { id: 12, description: "Comprender la relación entre la baja autoestima y las relaciones abusivas." },
            { id: 13, description: "Saber cuál es el momento adecuado para iniciar una relación sentimental y cómo la edad puede influir en ese momento." },
            { id: 14, description: "Desarrollar una lista de criterios, límites y condiciones para una relación sentimental personal." },
            { id: 15, description: "Conocer la importancia de ambos padres en una relación sentimental entre sus hijos." },
            { id: 16, description: "Comprender el plan de Dios para la sexualidad y hacer un voto personal de honrar ese plan." }
        ]
    },
    {
        id: "MIS-004",
        ...
        requirements: [
            { id: 1, description: "Ser capaz de presentarse, mencionando nombre, edad y donde vive en una lengua no nativa." },
            {
                id: 2,
            ...
            { id: 3, description: "Oír parte de un discurso, sermón o declaración de dos minutos, cuya lengua materna sea la lengua extranjera que usted escogió y explicar en sus palabras lo que entendió." },
            { id: 4, description: "Ser capaz de preguntar y comprender las instrucciones de como se llega a algún lugar en el idioma escogido." },
            {
                id: 5,
    ...
    },
    {
        ...
        requirements: [
            ...
            { id: 5, description: "¿Qué especie de mono brasileño estuvo a punto de extinguirse porque se los mataba por su cola para fabricar plumeros que se exportaban a Europa?" },
            { id: 6, description: "¿Cuál es el único primate en América capaz de usar objetos como herramientas para obtener alimento?" },
            { id: 7, description: "¿Qué porcentaje de primates hay en la Amazonía en comparación con el resto del mundo?" },
    ...
    },
    {
        ...
        requirements: [
            ...
            { id: 2, description: "Entender cuál fue la participación de Jesús en la creación del mundo, cuando fue identificado por Juan como el «Verbo» o «Palabra» de Dios (Juan 1:2-3; Colosenses 1:16-17)." },
            { id: 3, description: "Explicar cuál fue la participación de Jesús, en el plan de Dios, para salvar al ser humano de la muerte (Lucas 19:10)." },
            { id: 4, description: "Conocer lo que la Biblia dice de la naturaleza divina de Jesús (Juan 10:30; Hebreos 1:3; Juan 1:1; Colosenses 2:9)." },
            { id: 5, description: "Estudiar lo que la Biblia enseña sobre la naturaleza humana de Jesús (Juan 1:14; Hebreos 4:15; 1 Juan 4:2; Filipenses 2:6-8)." },
            { id: 6, description: "Memorizar y recitar algunos nombres o títulos que el profeta Isaías usa para Jesús (Isaías 9:6; 7:14)." },
            { id: 7, description: "Compartir con un amigo cuáles son las promesas que Jesús hace a los que creen en Él (Juan 11:25-26; 14:1-3)." }
        ]
    },
];